...
% Calcule le champs de contrainte à partir d'un champs de déplacement 2D
%
% Paramètres:
%   - omega : le maillage support du champs de déplacement
%   - B : le tenseur de Hook dans sa notation de Voigt (matrice)
%   - u : le champs de déplacement 2D
%
...
% éléments
    ...
    assert(isnumeric(u) && numel(u) == 2*omega.nbNodes,'Mauvais champs de déplacement 2D');
